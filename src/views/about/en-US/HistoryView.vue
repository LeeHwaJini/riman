      ...
      <ul class="history-list">
        <li data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">
          <div class="img-area type01">
            <img src="@assets/images/temp/prd_banner01.png" alt="" class="top-img">
            <img src="@assets/images/temp/prd_banner02.png" alt="" class="bottom-img">
          </div>
          <div class="text-area">
      ...
      <div class="max-width-1400">
        ...
        <div v-if="selectedCategory === 'all'" class="map-arae scroll type01">
          <div class="map-scroll-innnr">
            ...
            <div class="map-card canada">
              캐나다
              <i class="ico map" />
            </div>

            <div class="map-card usa">
              미국
              <i class="ico map" />
            </div>

            <div class="map-card korea">
              대한민국
              <i class="ico map" />
            </div>

            <div class="map-card taiwan">
              대만
              <i class="ico map" />
            </div>

            <div class="map-card hongkong">
              홍콩
              <i class="ico map" />
            </div>
          </div>
...
const mapData = [
  {
    category: 'korea',
    imgUrl: '/src/assets/images/about/riman_korea.png',
    ...
    tag: `<dt>법인 사이트</dt>
          <dd>
            ...
            <a href="www.mall.kr.riman.com" target="_blank">www.mall.kr.riman.com</a>
          </dd>
          <dt>본사 주소</dt>
          <dd>대구 수성구 동대구로 86</dd>
          <dt>서울사무소</dt>
          <dd>서울 강남구 테헤란로 509 엔씨타워</dd>
          <dt>전화번호</dt>
          <dd>1588-0000</dd>`
  },
  {
    category: 'korea',
    imgUrl: '/src/assets/images/about/riman_village.png',
    title: 'RIMAN Village',
    content: '',
    tag: `<dt>주소</dt>
  ...
  {
    category: 'america',
    imgUrl: '/src/assets/images/about/riman_north_america.png',
    title: 'Korea (Global HQ)',
    content: '',
    tag: `<dt>법인 사이트</dt>
          <dd>
  ...
  {
    category: 'taiwan',
    imgUrl: '/src/assets/images/about/riman_taiwan.png',
    title: 'RIMAN Taiwan',
    content: '',
    tag: `<dt>법인 사이트</dt>
          <dd>
  ...
  {
    category: 'hongkong',
    imgUrl: '/src/assets/images/about/riman_hongkong.png',
